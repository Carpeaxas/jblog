	...
	<c:import url="/WEB-INF/views/includes/blog-header.jsp"></c:import>
		...
		<div id="content">
			<ul id="admin-menu" class="clearfix">
				...
				<li class="tabbtn"><a href="${pageContext.request.contextPath}/${id}/admin/cate">카테고리</a></li>
				<li class="tabbtn"><a href="">글작성</a></li>
			</ul>
			<!-- //admin-menu -->
			
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${id}/update" method="post" enctype="multipart/form-data" >
	 		      	<table id="admin-basic">
			      		...
			      		<tr>
			      			...
			      			<td><input id = "id" type="hidden" name = "id" value="${blogVo.id}"></input></td>
